...
import {Input, Button, ButtonLoading} from "../index"
...
const handleSignup = async(data) =>{
   ...
   try {
    const session = await appwriteAuth.createUser(data)
    if (session) {
          ...
          >
            <div className="space-y-5">
              ...
              <Button
                ...
                type="submit"
              >
                 {isLoading ? <ButtonLoading fillColor="fill-black"/> :  <>Create Account <ArrowRight className="ml-2" size={16} /></> }
