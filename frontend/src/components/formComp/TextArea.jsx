...
function TextArea({ label, required = true, error = false, ...props }, ref) {
  ...
  return (
    <div className="w-full">
      ...
      <textarea
        className={`flex h-28 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-md placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 mt-1 ${
